...
# `palmerpenguins`:<br><br>Palmer Archipelago (Antarctica) Penguin Data
...
## `palmerpenguins`: Palmer Archipelago<br>(Antarctica) Penguin Data
.pull-left[
...
# `magrittr`:<br><br>A Forward-Pipe Operator for R
...
.footnote[
_Note: Find more information about `%>%` by running `vignette("magrittr")`. Type `%>%` using the shortcut: *ctrl + shift + M*._
]
