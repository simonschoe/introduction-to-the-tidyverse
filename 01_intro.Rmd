...
.footnote[
*Note: For the communication and modeling part of the workflow refer to the `rmarkdown` and `tidymodels` workshop.*
]
...
- Consistent order of function arguments (e.g., `arg1 = data, arg2 = col names, ...`)
- ...
...
.footnote[
_Note: For further information cf. [[2]](#references) and [[3]](#references)._
]
