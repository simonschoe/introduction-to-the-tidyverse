...
- **`dplyr::left_join()`, `dplyr::right_join()`, `dplyr::inner_join()` and `dplyr::full_join()`:** merges different data frames by matching rows based on keys (similar to joins performed in SQL)
