...
```
Most of the time you will just plot the data as-is (`stat = "identity"`). As soon as you require some form of statistical transformation (e.g., count, density or unique) before plotting, the `stat` argument can handle this for you. It goes hand-in-hand with the respective `geom_*()`.
]
.pull-right[
