...
Within the `tidyverse`, the tilde-shorthand regularly occurs whenever an external function is required as an argument to one of the `tidyverse` functions. In general, you as a user have different ways of including the second function call, one of which is the tilde shorthand notation.
...
knitr::include_graphics(
  "https://tenor.com/view/the-office-finger-guns-right-on-steve-carell-michael-scott-gif-4724041.gif"
)
```
<br><br>
