...
```{r child='02_tidy_data.Rmd', eval=F}
```

---

```{r child='03_magrittr.Rmd', eval=F}
```

---

```{r child='04_tibble.Rmd', eval=F}
```

---

```{r child='05_readr.Rmd', eval=F}
```

---

```{r child='06_tidyr.Rmd', eval=F}
```

---

```{r child='07_dplyr.Rmd', eval=F}
```

---

```{r child='08_purrr.Rmd', eval=F}
```

---

```{r child='09_ggplot2.Rmd', eval=F}
```
